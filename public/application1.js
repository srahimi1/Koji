...
function drawLine() {
    ...
    var combinedIndex;
    if (numberOfLinesDrawnOnCanvas < Math.floor(300*.7)) {
        ind = ((width/30) * Math.floor(Math.random() * 30));
        ...
        for (var i = 0; i < 30; i++) {
            var a = (i * Math.floor(width/30)) + ",0";
            var b = (i * Math.floor(width/30)) + ",1";
            var c = (i * Math.floor(width/30)) + ",2";
            var d = (i * Math.floor(width/30)) + ",3";
            var e = (i * Math.floor(width/30)) + ",4";
            var f = (i * Math.floor(width/30)) + ",5";
            var g = (i * Math.floor(width/30)) + ",6";
            var h = (i * Math.floor(width/30)) + ",7";
            var j = (i * Math.floor(width/30)) + ",8";
            var k = (i * Math.floor(width/30)) + ",9";
            if (!linesDrawnSoFar[a]) {combinedIndex = a; ind = (i * Math.floor(width/30)); vpos = 0; break;}
            else if (!linesDrawnSoFar[b]) {combinedIndex = b; ind = (i * Math.floor(width/30)); vpos = 1;  break;}
            else if (!linesDrawnSoFar[c]) {combinedIndex = c; ind = (i * Math.floor(width/30)); vpos = 2;  break;}
            else if (!linesDrawnSoFar[d]) {combinedIndex = d; ind = (i * Math.floor(width/30)); vpos = 3;  break;}
            else if (!linesDrawnSoFar[e]) {combinedIndex = e; ind = (i * Math.floor(width/30)); vpos = 4;  break;}
            else if (!linesDrawnSoFar[f]) {combinedIndex = f; ind = (i * Math.floor(width/30)); vpos = 5;  break;}
            else if (!linesDrawnSoFar[g]) {combinedIndex = g; ind = (i * Math.floor(width/30)); vpos = 6;  break;}
            else if (!linesDrawnSoFar[h]) {combinedIndex = h; ind = (i * Math.floor(width/30)); vpos = 7;  break;}
            else if (!linesDrawnSoFar[j]) {combinedIndex = j; ind = (i * Math.floor(width/30)); vpos = 8;  break;}
            else if (!linesDrawnSoFar[k]) {combinedIndex = k; ind = (i * Math.floor(width/30)); vpos = 9;  break;}
    ...
    switch(vpos) {
        case 0:
            ctx2.clearRect(ind,0,Math.floor(width/30),len);
            break;
        case 1:
            ctx2.clearRect(ind,len,Math.floor(width/30),len);
            break;
        case 2:
            ctx2.clearRect(ind,2*len,Math.floor(width/30),len);
            break;
        case 3:
            ctx2.clearRect(ind,3*len,Math.floor(width/30),len);
            break;
        case 4:
            ctx2.clearRect(ind,4*len,Math.floor(width/30),len);
            break;
        case 5:
            ctx2.clearRect(ind,5*len,Math.floor(width/30),len);
            break;
        case 6:
            ctx2.clearRect(ind,6*len,Math.floor(width/30),len);
            break;
        case 7:
            ctx2.clearRect(ind,7*len,Math.floor(width/30),len);
            break;
        case 8:
            ctx2.clearRect(ind,8*len,Math.floor(width/30),len);
            break;
        case 9:
            ctx2.clearRect(ind,9*len,Math.floor(width/30),len);
            break;
    }
    canvas2.style.display = "block";
...
function showLetters() {
    drawLine();
    if (numberOfLinesDrawnOnCanvas < 300) showLettersTimeoutID = setTimeout(function() {showLetters()}, 10);
